module.exports = {
              ...
              fixed_list_items: [
                {
                  ...
                  label:
                    'My client is not appealing an EU Settlement Scheme decision',
                  order: null,
                },
              ],
              complex_fields: [],
              ...
              fixed_list_items: [
                {
                  ...
                  label:
                    'My client is not appealing with anyone else as part of a linked or grouped appeal',
                  order: null,
                },
              ],
              complex_fields: [],
          ...
          complex_fields: [
            {
              ...
              field_type: {
                ...
                max: null,
                regular_expression:
                  '^(RP|PA|EA|HU|DC|DA|AA|IA|OA|VA)\\/[0-9]{5}\\/[0-9]{4}$',
                fixed_list_items: [],
                complex_fields: [],
                collection_field_type: null,
              },
  ...
  wizard_pages: [
    ...
    },
    {
      ...
      show_condition:
        'isFeePaymentEnabled="Yes" AND appealType!="deprivation" AND appealType!="revocationOfProtection"',
      callback_url_mid_event: null,
      retries_timeout_mid_event: [],
    },
    {
  ...
  _links: {
    self: {
      href:
        'http://gateway-ccd.aat.platform.hmcts.net/internal/case-types/Asylum/event-triggers/startAppeal?ignore-warning=false',
    },
  },
};
