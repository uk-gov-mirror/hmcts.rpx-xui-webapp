module.exports = {
  ...
  case_fields: [
    ...
    },
    {
      ...
      display_context_parameter: null,
      show_condition:
        'solsSolicitorIsExec="Yes" AND solsSolicitorIsMainApplicant="No"',
      show_summary_change_option: true,
      show_summary_content_option: null,
      acls: [
        {
    ...
    },
    {
      ...
      field_type: {
        ...
        fixed_list_items: [
          ...
          },
          {
            ...
            label:
              'They have appointed or wish to appoint another person to act as their attorney',
            order: null,
          },
          {
            code: 'Renunciation',
      ...
      display_context_parameter: null,
      show_condition:
        'solsSolicitorIsApplying="No" AND solsSolicitorIsExec="Yes" AND solsSolicitorIsMainApplicant="No"',
      show_summary_change_option: true,
      show_summary_content_option: null,
      acls: [
        {
  ...
  _links: {
    self: {
      href:
        'http://gateway-ccd.aat.platform.hmcts.net/internal/case-types/GrantOfRepresentation/event-triggers/solicitorCreateApplication?ignore-warning=false',
    },
  },
};
