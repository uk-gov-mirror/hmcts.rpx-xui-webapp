module.exports = {
  ...
  case_fields: [
    ...
    },
    {
      ...
      display_context_parameter: null,
      show_condition:
        'orderForChildrenQuestion1="Yes" AND natureOfApplication5="No"',
      show_summary_change_option: true,
      show_summary_content_option: null,
      acls: [
        {
    ...
    },
    {
      ...
      metadata: false,
      hint_text:
        'You can either submit one joint D81 form for both parties or one for each applicant and respondent',
      field_type: {
        id: 'YesOrNo',
        type: 'YesOrNo',
        min: null,
  ...
  wizard_pages: [
    {
      ...
      callback_url_mid_event:
        'http://finrem-cos-aat.service.core-compute-aat.internal/case-orchestration/consented/set-defaults',
  ...
  _links: {
    self: {
      href:
        'http://gateway-ccd.aat.platform.hmcts.net/internal/case-types/FinancialRemedyMVP2/event-triggers/FR_solicitorCreate?ignore-warning=false',
    },
  },
};
