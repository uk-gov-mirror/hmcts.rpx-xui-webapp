module.exports = {
  ...
  case_fields: [
    {
      ...
      metadata: false,
      hint_text:
        "If applying through a solicitor, provide the solicitor's email instead",
      field_type: {
        id: 'Text',
        type: 'Text',
        min: null,
    ...
    },
    {
      id: 'caveatorAddress',
      label:
        "Address - (If applying through a solicitor, provide the solicitor's firm name and address instead)",
      hidden: null,
      value: null,
      metadata: false,
      hint_text: null,
  ...
  _links: {
    self: {
      href:
        'http://gateway-ccd.aat.platform.hmcts.net/internal/case-types/Caveat/event-triggers/solicitorCreateCaveat?ignore-warning=false',
    },
  },
};
