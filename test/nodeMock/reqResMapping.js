...
const requestMapping = {
  get: {
    ...
    '/data/internal/case-types/:jurisdiction/work-basket-inputs': (
      req,
      res
    ) => {
      res.send(ccdApiMock.getWorkbasketInputs(req.params.jurisdiction));
    },
    '/data/internal/case-types/:jurisdiction/event-triggers/:caseType': (
      req,
      res
    ) => {
      res.send(
        ccdApiMock.getSolicitorCreateCaseConfig(
    ...
    '/data/caseworkers/:uid/jurisdictions/:jurisdiction/case-types/:casetype/cases/pagination_metadata': (
      req,
      res
    ) => {
  ...
  post: {
    ...
    '/api/inviteUser': (req, res) => {
      res.send({
        userIdentifier: '97ecc487-cdeb-42a8-b794-84840a4testc',
        idamStatus: null,
      });
    },
    ...
    users: [
      {
        ...
        idamStatusCode: ' ',
        idamMessage:
          "19 No call made to SIDAM to get the user roles as user status is not 'ACTIVE'",
      },
      {
...
function getWorkbasketCases() {
  ...
  for (let rowCounter = 0; rowCounter < 250; rowCounter++) {
    rows.push({
      ...
      case_fields: {
        solsConfirmSignSOT2:
          'You will sign a statement of truth on your client’s behalf.',
        solsConfirmSignSOT3:
        ...
        solsConfirmSignSOT1:
          'You won’t be able to make changes to the legal statement and declaration after continuing.',
        ...
        solsLifeInterestInfo:
          'You can’t use this service if there is a life interest in respect of the estate.',
        ...
        solsEntitledMinorityInfo:
          'You can’t use this service if there is a beneficiary under the age of 18.',
        ...
        solsResiduaryInfo:
          'You can’t use this service if you are not named in the will as a residuary legatee or devisee.',
        solsSolicitorEmail: 'wdwedwe@gmail.com',
        solsMinorityInterestInfo:
          'You can’t use this service if there is a minority interest.',
        solsApplicantSiblingsInfo:
          'You can’t use this service if the applicant has any siblings.',
        deceasedNameSection:
          "### What's the full name of the deceased? nUse the name on the death certificate",
        solsIht400extraInfo:
          "You'll need to send a stamped (receipted) IHT 421 with this application.",
        solsExecutorInfoSection:
          'Enter all executors named in the will. Only 4 lay executors can apply.',
        ...
        noProofEntitlement:
          'The will is not entitled to proof in England and Wales.',
