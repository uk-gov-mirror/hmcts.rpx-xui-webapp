...
class CreateCaseWizardPage {
  constructor() {
    ...
    this.addnewButton = new Button(
      '#appeal_appealReasons_reasons button:nth-child(2)'
    );
    ...
    this.appealMrnDetailsMrnMissingReason =
      'appeal_mrnDetails_mrnMissingReason';
    ...
    this.appealAppellantIdentityDobMonth =
      'appeal_appellant_identity_dob-month';
    ...
    this.appealAppellantAppointeeNameTitle =
      'appeal_appellant_appointee_name_title';
    this.appealAppellantNameAppointeeFirstName =
      'appeal_appellant_appointee_name_firstName';
    this.appealAppellantNameAppointeeMiddleName =
      'appeal_appellant_appointee_name_middleName';
    this.appealAppellantNameAppointeeLastName =
      'appeal_appellant_appointee_name_lastName';
    this.appealAppellantIdentityAppointeeDobDay =
      'appeal_appellant_appointee_identity_dob-day';
    this.appealAppellantIdentityAppointeeDobMonth =
      'appeal_appellant_appointee_identity_dob-month';
    this.appealAppellantIdentityAppointeeDobYear =
      'appeal_appellant_appointee_identity_dob-year';
    this.appealAppellantAppointeeIdentityNino =
      'appeal_appellant_appointee_identity_nino';
    this.appealAppellantAppointeeAddressLine1 =
      'appeal_appellant_appointee_address_line1';
    this.appealAppellantAppointeeAddressLine2 =
      'appeal_appellant_appointee_address_line2';
    this.appealAppellantAppointeeAddressLine3 =
      'appeal_appellant_appointee_address_line3';
    this.appealAppellantAppointeeAddressTown =
      'appeal_appellant_appointee_address_town';
    this.appealAppellantAppointeeAddressCounty =
      'appeal_appellant_appointee_address_county';
    this.appealAppellantAppointeeAddressPostcode =
      'appeal_appellant_appointee_address_postcode';
    this.appealAppellantAppointeeAddressCountry =
      'appeal_appellant_appointee_address_country';
    this.appealAppellantAppointeeContactPhone =
      'appeal_appellant_appointee_contact_phone';
    this.appealAppellantAppointeeContactMobile =
      'appeal_appellant_appointee_contact_mobile';
    this.appealAppellantAppointeeContactEmail =
      'appeal_appellant_appointee_contact_email';
    this.appealAppellantIsAddressSameAsYes =
      'appeal_appellant_isAddressSameAsAppointee-Yes';
    this.appealAppellantIsAddressSameAsNo =
      'appeal_appellant_isAddressSameAsAppointee-No';
    ...
    this.appealHearingOptionsWantsToAttendYes =
      'appeal_hearingOptions_wantsToAttend-Yes';
    this.appealHearingOptionsWantsToAttendNo =
      'appeal_hearingOptions_wantsToAttend-No';
    this.appealHearingOptionsLanguageInterpreterYes =
      'appeal_hearingOptions_languageInterpreter-Yes';
    this.appealHearingOptionsLanguageInterpreterNo =
      'appeal_hearingOptions_languageInterpreter-No';
    this.appealHearingOptionsOther = 'appeal_hearingOptions_other';
    this.appealHearingOptionsSignLanguageType =
      'appeal_hearingOptions_signLanguageType';
    this.appealAppealReasonsReason = 'appeal_appealReasons_reasons_0_reason';
    this.appealAppealReasonsReasonsDescription =
      'appeal_appealReasons_reasons_0_description';
    ...
    this.regionalProcessingCenterPhoneNumber =
      'regionalProcessingCenter_phoneNumber';
    this.regionalProcessingCenterFaxNumber =
      'regionalProcessingCenter_faxNumber';
  ...
  async clickCollectionAddNewButton(collectionFieldId) {
    let xpathLocator = await this.collectionAddNewElementButtonXPathTemplate.replace(
  ...
  async getCheckYourAnswersValueByLabel(labelText) {
    ...
    let xpathLocator = await this.answerValueXpathTemplate.replace(
  ...
  async clickChangeLink(labelText) {
    let label = await labelText.replace(' (Optional)', '');
    let xpathLocator = await this.answerChangeLinkXpathTemplate.replace(
      'LABEL-TEXT-PLACEHOLDER',
      label
    );
    await element(by.xpath(xpathLocator)).click();
