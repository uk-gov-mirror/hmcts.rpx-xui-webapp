...
class TaskListPage extends TaskList {
  constructor() {
    super();
    this.subNavListContainer = $(
      'xuilib-hmcts-sub-navigation .hmcts-sub-navigation__list'
    );
    this.myTasksTab = element(
      by.xpath("//exui-task-home//a[contains(text(),'My tasks')]")
    );
    this.availableTasksTab = element(
      by.xpath("//exui-task-home//a[contains(text(),'Available tasks')]")
    );
