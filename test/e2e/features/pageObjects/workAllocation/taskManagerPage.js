...
class TaskManagerPage extends TaskList {
  constructor() {
    ...
    this.caseWorkerFilter = $(
      'exui-task-manager-filter select#task_assignment_caseworker'
    );
    this.locationFilter = $(
      'exui-task-manager-filter select#task_assignment_location'
    );
