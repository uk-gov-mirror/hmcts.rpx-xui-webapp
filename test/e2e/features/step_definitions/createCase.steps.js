...
defineSupportCode(function ({ And, But, Given, Then, When }) {
  ...
  When(
    /^I enter mandatory probate fields jurisdiction,case type,event and click on start button$/,
    async function () {
      browser.sleep(AMAZING_DELAY);
      await createCaseStartPage.selectJurisdiction(
        TestData.probatejurisdiction
      );
  ...
  When(
    /^I Enter mandatory case details and click on continue button$/,
    async function () {
  ...
  When(/^I enter event details and click on submit button$/, async function () {
    ...
    await appealCreatedPage.enterIntoTextFieldEventDes(
  ...
  When(
    /^I Enter mandatory details and click on save and continue button$/,
    async function () {
      browser.sleep(LONG_DELAY);
  ...
  Then(
    /^I should navigate to reason for the divorce page$/,
    async function () {}
  );
  When(
    /^I enter mandatory divorces fields jurisdiction,case type,event and click on start button$/,
    async function () {
      browser.sleep(AMAZING_DELAY);
      await createCaseStartPage.selectJurisdiction(
        TestData.divorcesjurisdiction
      );
  ...
  When(
    /^I enter mandatory fr fields jurisdiction,case type,event and click on start button$/,
    async function () {
