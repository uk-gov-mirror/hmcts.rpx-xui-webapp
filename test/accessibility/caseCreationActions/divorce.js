...
function divorceCaseCreationPages() {
  ...
  for (
    let actionCounter = 0;
    actionCounter < allActions.length;
    actionCounter++
  ) {
    ...
    switch (action.action) {
      case 'sendkeys':
        actionsCollectionArray.push(
          ...pallyActions.inputField(action.locator, action.input)
        );
        break;
      case 'select':
        actionsCollectionArray.push(
          ...pallyActions.clickElement(action.locator)
        );
        actionsCollectionArray.push(
          ...pallyActions.selectOptionClick(
            action.locator + " option[value = '" + action.input + "']"
          )
        );
        break;
      case 'click':
        if (action.locator.includes('option')) {
          ...
          actionsCollectionArray.push(
            ...pallyActions.clickElement(selectFieldcss)
          );
        }
        actionsCollectionArray.push(
          ...pallyActions.clickElement(action.locator)
...
let allActions = [
  ...
  },
  {
    ...
    action: 'sendkeys',
    input:
      '/Users/sreekanth/work/moj/ex-ui/rpx-xui-webapp/test/e2e/documents/dummy.pdf',
  },
  {
    locator: 'none',
    action: 'sleep 1000',
  ...
  },
  {
    ...
    action: 'pageUrlTobe',
    input:
      'https://manage-case.aat.platform.hmcts.net/cases/case-create/DIVORCE/DIVORCE/solicitorCreate/submit',
  },
];
