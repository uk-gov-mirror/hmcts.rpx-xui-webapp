 ...
 * getNoCQuestions
 */
export async function getNoCQuestions(
  req: EnhancedRequest,
  res: Response,
  next: NextFunction
) {
  ...
  try {
    const {
      status,
      data,
    }: { status: number; data: NoCQuestions } = await handleGet(
      markupPath,
      req
    );
...
export async function validateNoCQuestions(
  req: EnhancedRequest,
  res: Response,
  next: NextFunction
) {
  ...
  try {
    const {
      status,
      data,
    }: { status: number; data: NoCQuestions } = await handlePost(
      markupPath,
      body,
      req
    );
...
export async function submitNoCEvents(
  req: EnhancedRequest,
  res: Response,
  next: NextFunction
) {
