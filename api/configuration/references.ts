...
export const SERVICES_CCD_CASE_ASSIGNMENT_API_PATH =
  'services.ccd.caseAssignmentApi';
export const SERVICES_WORK_ALLOCATION_TASK_API_PATH =
  'services.work_allocation.taskApi';
export const SERVICES_ROLE_ASSIGNMENT_API_PATH =
  'services.role_assignment.roleApi';
...
export const SERVICES_IDAM_OAUTH_CALLBACK_URL =
  'services.idam.oauthCallbackUrl';
