...
export const applicationConfiguration = () => {
  return {
    ...
    featureTermsAndConditionsEnabled: showFeature(
      FEATURE_TERMS_AND_CONDITIONS_ENABLED
    ),
    ...
    servicesCcdCaseAssignmentPath: getConfigValue(
      SERVICES_CCD_CASE_ASSIGNMENT_API_PATH
    ),
    ...
    servicesTermsAndConditionsPath: getConfigValue(
      SERVICES_TERMS_AND_CONDITIONS_URL
    ),
    workAllocationTaskPath: getConfigValue(
      SERVICES_WORK_ALLOCATION_TASK_API_PATH
    ),
  };
};
