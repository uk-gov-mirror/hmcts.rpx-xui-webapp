...
export function preparePostTaskUrlAction(
  baseUrl: string,
  taskId: string,
  action: string
): string {
...
export function prepareGetLocationByIdUrl(
  baseUrl: string,
  locationId: string
): string {
...
export function prepareCaseWorkerForLocation(
  baseUrl: string,
  locationId: string
) {
...
export function prepareCaseWorkerForService(
  baseUrl: string,
  serviceId: string
) {
...
export function prepareCaseWorkerForLocationAndService(
  baseUrl: string,
  locationId: string,
  serviceId: string
) {
