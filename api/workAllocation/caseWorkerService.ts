...
export async function handleCaseWorkerGetAll(
  path: string,
  req: EnhancedRequest
): Promise<any> {
...
export async function handleCaseWorkerForLocation(
  path: string,
  req: EnhancedRequest
): Promise<any> {
...
export async function handleCaseWorkerForService(
  path: string,
  req: EnhancedRequest
): Promise<any> {
...
export async function handleCaseWorkerForLocationAndService(
  path: string,
  req: EnhancedRequest
): Promise<any> {
...
export async function handleCaseWorkerDetails(
  path: string,
  req: EnhancedRequest
): Promise<any> {
...
export async function handlePostRoleAssingnments(
  path: string,
  payload: any,
  req: EnhancedRequest
): Promise<any> {
...
export async function handlePostCaseWorkersRefData(
  path: string,
  userIds: any,
  req: EnhancedRequest
): Promise<any> {
