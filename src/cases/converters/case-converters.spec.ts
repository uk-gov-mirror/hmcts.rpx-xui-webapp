...
describe('case converters', () => {
  it('should convert to share case', () => {
    ...
    const expectedShareCases = [
      {
        caseId: '1',
        caseTitle: 'James Priest Vs Charlotte Godard',
        caseTypeId: 'FinancialRemedyContested',
      },
      {
        caseId: '2',
        caseTitle: 'Kenneth Priest Vs Kathy Godard',
        caseTypeId: 'FinancialRemedyContested',
      },
    ];
    const shareCases: SharedCase[] = converts.toShareCaseConverter(
      selectedCases
    );
  ...
  it('should convert to search result view item', () => {
    ...
    const searchResultViewItem: SearchResultViewItem[] = converts.toSearchResultViewItemConverter(
      sharedCases
    );
