...
export const CASELIST_JURISDICTION_SELECTED =
  '[CreateCaselist] Jurisdiction Selected';
...
export const APPLY_CASELIST_FILTER_FOR_ES =
  '[CreateCaselist] Apply Caselist Filter for ES';
export const APPLY_CASELIST_FILTER_SUCCESS =
  '[CreateCaselist] Apply Caselist Filter Success';
export const APPLY_CASELIST_FILTER_FAIL =
  '[CreateCaselist] Apply Caselist Filter Fail';
export const FIND_CASELIST_PAGINATION_METADATA =
  '[CreateCaselist] Find caselist pagination metadata';
export const FIND_CASELIST_PAGINATION_METADATA_SUCCESS =
  '[CreateCaselist] Find caselist pagination metadata success';
export const CASELIST_RESULT_PAGE_CHANGE =
  '[CreateCaselist] Caselist result page change';
export const CASE_FILTER_DISPLAY_TOGGLE =
  '[CreateCaseList] toggle caselist filter';
export const CASE_FILTER_DISPLAY_TOGGLE_SUCCESS =
  '[CreateCaseList] toggle caselist filter success';
