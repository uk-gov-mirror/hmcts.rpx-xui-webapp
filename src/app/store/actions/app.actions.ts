...
export const LOAD_TERMS_CONDITIONS_SUCCESS =
  '[TC] Load Terms Conditions Success';
...
export const LOAD_FEATURE_TOGGLE_CONFIG_SUCCESS =
  '[App] Load Feature Toggle Config Success';
export const LOAD_FEATURE_TOGGLE_CONFIG_FAIL =
  '[App] Load Feature Toggle Config Fail';
