...
export const ROUTES: Routes = [
  ...
  },
  {
    ...
    canActivate: [AuthGuard, AcceptTermsGuard],
    loadChildren:
      '../work-allocation/work-allocation.module#WorkAllocationModule',
  },
  // TODO: remove redundant redirections
  {
    path: 'case/:jurisdiction/:case-type/:cid',
    redirectTo: 'cases/case-details/:cid',
    pathMatch: 'full',
  },
  {
    path: 'case/:cid',
  ...
  },
  {
    ...
    redirectTo: 'cases/case-details/:cid/trigger/:triggerPath',
    pathMatch: 'full',
  },
  {
    path:
      'case/:jurisdiction/:case-type/:cid/trigger/:triggerPath/:triggerPath2',
    redirectTo: 'cases/case-details/:cid/trigger/:triggerPath/:triggerPath2',
    pathMatch: 'full',
  },
  {
    path: 'noc',
