...
class WrapperComponent {
  @ViewChild(TaskAssignmentContainerComponent)
  public appComponentRef: TaskAssignmentContainerComponent;
...
describe('TaskAssignmentContainerComponent', () => {
  ...
  beforeEach(() => {
    ...
    window.history.pushState(
      { returnUrl: 'tasks/list', showAssigneeColumn: false },
      '',
      'tasks/list'
    );
  ...
  it('should assign succesfully', () => {
    ...
    expect(mockWorkAllocationService.assignTask).toHaveBeenCalledWith(
      mockTasks[0].id,
      assignee
    );
  });
