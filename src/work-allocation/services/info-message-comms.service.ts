...
export class InfoMessageCommService {
  public infoMessageSource: BehaviorSubject<
    InformationMessage[]
  > = new BehaviorSubject<InformationMessage[]>([]);

  public infoMessageChangeEmitted$: Observable<
    InformationMessage[]
  > = this.infoMessageSource.asObservable();
