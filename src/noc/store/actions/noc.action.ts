...
export const SET_CASE_REF_VALIDATION_FAILURE =
  '[NOC] Set Case Reference Validation Failure';
export const SET_QUESTIONS = '[NOC] Set Questions';
export const SET_CASE_REF_SUBMISSION_FAILURE =
  '[NOC] Set Case Reference Submission Failure';
...
export const SET_ANSWER_SUBMISSION_FAILURE =
  '[NOC] Set Answer Submission Failure';
export const SET_AFFIRMATION_AGREED = '[NOC] Set Affirmation Agreed';
export const SET_AFFIRMATION_DISAGREE_ERROR =
  '[NOC] Set Affirmation Disagree Error';
export const SUBMIT_NOC = '[NOC] Submit NoC';
export const SET_SUBMISSION_SUCCESS_APPROVED =
  '[NOC] Submission NoC Success Approved';
export const SET_SUBMISSION_SUCCESS_PENDING =
  '[NOC] Submission NoC Success Pending';
...
export class SetQuestions implements Action {
  ...
  constructor(
    public payload: { questions: NocQuestion[]; caseReference: string }
  ) {}
}
